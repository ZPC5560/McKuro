...
public static class KuroEndpoints
{
    ...
    public static string ForServerType(donet.Core.Services.Game.GameServerType type) => type switch
    {
        donet.Core.Services.Game.GameServerType.Bilibili => BilibiliIndex,
        donet.Core.Services.Game.GameServerType.Global => GlobalIndex,
        _ => CnIndex,
    };
}
