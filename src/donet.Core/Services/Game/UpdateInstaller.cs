...
/// 替换文件前备份到 <c>.donet_backup</c>,安装完成后写入版本标记。
/// </summary>
public sealed class UpdateInstaller
{
    public const string BackupDirName = ".donet_backup";

    /// <summary>计算需要下载/更新的文件(缺失或 MD5 不一致)。</summary>
    public UpdateDiff ComputeDiff(GameManifest manifest, string gameRootDir)
    {
